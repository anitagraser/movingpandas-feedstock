...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/movingpandas-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/movingpandas-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add movingpandas
# for installing globally
pixi global install movingpandas
```
...
It is possible to list all of the versions of `movingpandas` available on your platform:
...
```
pixi search movingpandas --channel conda-forge
```
